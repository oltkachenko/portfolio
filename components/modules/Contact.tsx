...
export default function Contact({ formTranslation, contact }: Props) {
    ...
    return (
        <GridLayout style={{"--bg-layout-color": contact.backgroundColor?.value} as React.CSSProperties}>
            <section className='contact'>
                <Heading data={{
                    title: contact.title,
                    subtitle: contact.subtitle,
                    alignment: contact.headingAlignment
                }}/>
